...
file_path = r'C:\Users\freet\Desktop\3학년2학기\인공지능\과제\꽃 분류\train_data_rotate\marigold'  # 늘릴 해당 파일 경로
...
for file_name in file_names:  # 파일들 하나씩 불러오기
    if file_name.endswith('.jpg'):  # 확장자가 jpg일때만
        ...
        save_image_path = r'C:\Users\freet\Desktop\3학년2학기\인공지능\과제\꽃 분류\train_data_rotate\marigold'  # 저장할 이미지
